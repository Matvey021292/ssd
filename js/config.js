var CONFIG = {
  ...
  "inputs-template" : {
    "firstname" : "<div class='form_group--name form_group--first '> <input data-validation-type='firstname' name='firstname' placeholder='Name' required><div class='validation'><i class='fa fa-exclamation'></i></div> <div class='error'></div></div>",
    "lastname" : "<div class='form_group--name form_group--last form_group--first'> <input data-validation-type='lastname' placeholder='Lastname' name='lastname' value='' required><div class='validation'><i class='fa fa-exclamation'></i></div> <div class='error'></div></div>",
    ...
    "conditions" : "<div class='checkbox-wrapper'> <label><span class='check'></span><input checked class='inverted' required name='conditions' type='checkbox' data-validation-type='conditions'><p>I’m over 18, I accept  <a href='#' onclick='termFade(event)' class='footer-link_popup1'>terms and conditions</a></p></label><div class='validation'><i class='fa fa-exclamation'></i></div> <div class='error'></div></div>",
